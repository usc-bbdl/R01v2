...
bool dataAcquisitionFlag[12] = {true,true,true,true,false,false,false,false,false,false,false,false}; //force(0), EMG(1), spindleIa(2), spindleII(3),spikeCount(4),raster1(5),raster2(6),raster3(7),raster4(8),raster5(9),raster6(10), real-time control cortex(11)
